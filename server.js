...
app.post('/sendmailcodellion',function(req,res){
  var transporter = nodemailer.createTransport({
                 service: 'gmail',
                 auth: {
                     user: 'codellionemenu@gmail.com',
               ...
               var mailOptions = {
                 from: 'maheshkunder24@gmail.com',
                 to: "codellionapps@gmail.com",
                 subject: 'New Client From Codellion-Emenu',
                 html:`<html>
                 <head>
                     <title></title>
                 </head>
                                                                     ...
                                                                     "78%">
                                                                         <tbody>
                                                                             <tr>
                                                                                 ...
                                                                                 "center" style=
                                                                                 "font-family:'Open Sans',arial,sans-serif!important;font-size:16px!important;line-height:30px!important;font-weight:400!important;color:#7e8890!important">
                                                                                 Email:` +req.body.email+`,phone:` +req.body.phone+`,Message:` +req.body.message+`</td>
                                                                             </tr>
                                                                         </tbody>
                                                                     </table>
                                                                 </td>
